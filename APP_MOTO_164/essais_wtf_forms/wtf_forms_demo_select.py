...
"""
    ...
    But : Montrer l'utilisation d'une liste déroulante (WTF) dont le contenu est basé sur la table "t_marque"
    
"""


class DemoFormSelectWTF(FlaskForm):
    marques_dropdown_wtf = SelectField('marques (liste déroulante)',
                                      validators=[DataRequired(message="Sélectionner un marque.")],
    ...
    #                                   coerce=int
    #                                   )
    submit_btn_ok_dplist_marque = SubmitField("Choix marque")
