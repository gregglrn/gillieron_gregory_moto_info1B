...
class ExceptionmarquesAfficher(Base):
    pass


class ExceptionmarqueDeleteWtf(Base):
    pass


class ExceptionmarqueUpdateWtf(Base):
    pass


class ExceptionmarquesAjouterWtf(Base):
    pass


class ExceptionMotosmarquesAfficher(Base):
    pass


class ExceptionEditmarqueMotoselected(Base):
    pass


class ExceptionUpdatemarqueMotoselected(Base):
    pass


class ExceptionmarquesMotosAfficherData(Base):
    pass


class ExceptionMotoUpdateWtf(Base):
    pass


class ExceptionMotoDeleteWtf(Base):
    pass


class ExceptionInitAppMotos164(Base):
    pass
...
def gg_104_exception_handler(error):
