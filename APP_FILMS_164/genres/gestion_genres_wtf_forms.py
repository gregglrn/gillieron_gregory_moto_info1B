...
class FormWTFAjouterGenres(FlaskForm):
    ...
    nom_genre_wtf = StringField("Clavioter le nom du client ", validators=[Length(min=2, max=20, message="min 2 max 20"),
...
class FormWTFUpdateGenre(FlaskForm):
    ...
    nom_genre_update_wtf = StringField("Clavioter le nom du client ", validators=[Length(min=2, max=20, message="min 2 max 20"),
