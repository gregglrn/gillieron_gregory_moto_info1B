    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_genre = """INSERT INTO t_personne (id_personne, prenom_personne) VALUES (NULL,%(value_intitule_genre)s) """
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_pers_moto WHERE fk_personne = %(value_id_genre)s"""
        ...
        if request.method == "GET":
            ...
            str_sql_genres_films_delete = """SELECT id_pers_moto, marque_moto, id_personne, prenom_personne FROM t_pers_moto 
                                            INNER JOIN t_moto ON t_pers_moto.fk_moto = t_moto.id_moto
                                            INNER JOIN t_personne ON t_pers_moto.fk_personne = t_personne.id_personne
